...
export default async function Home() {
  ...
  return (
    <section className="min-h-screen bg-grid-zinc-50">
      <MaxWidthWrapper className="relative pb-24 sm:pb-32">
        ...
        <div className="px-6 lg:px-0 lg:pt-4">
          ...
          <div className="relative mx-auto text-center flex flex-col items-center">
            <h1 className="relative leading-snug w-fit tracking-tight text-balance mt-8 font-bold text-gray-900 text-5xl md:text-6xl">
              What do you{" "}
